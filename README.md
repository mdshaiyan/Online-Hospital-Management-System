...
<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/d3e56cb0-d8a5-4b70-9ae5-219e5c218225" />
 ...
 Here we have in total 9 forms.And also here we set 4 role.They are : Admin, Doctor,Patient,Cashier.When admin can login they see the new interface of admin.

 <img width="1909" height="1078" alt="image" src="https://github.com/user-attachments/assets/f0bfd47a-3ff3-4ef1-8364-9f16fc477ed1" />

                  
Here we added the two roles.One is Doctor and another is Cashier.If we click on Doctor we can see the all information of Doctor in this table.

<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/dd76e7f5-92ec-471e-b32d-3e1eb9b98626" />

Also if we want to check we can click on Cashier and then we can see the all information of Cashier.

<img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/2c731885-5e2e-43d1-b7e4-7c41a148785e" />

 Now if we want to create an account of Doctor or Cashier then we click on create button and then we can see this interface 

 <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/aed84e4f-cf0a-4525-8850-5d3ce07864db" />
